    ...
    <React.Fragment>
      {row.orderdate == cd ? <>
        ...
        <TableCell>
          ...
          <TableCell component="th" scope="row" ><div style={{width:73, overflow:'hidden'}}> {row.orderdate}</div></TableCell>
...
export default function ViewOrder2(props) {
  ...
  return (
    ...
    />
      <Table aria-label="collapsible table" >
        <TableHead>
          <TableRow>
            <TableCell />
            <TableCell align="centre">Order<br/>Date</TableCell>
    ...
    <Button style={{margin:50}} variant='outlined' color='primary' onClick={(event)=>viewcurrentorder(event)} >View Current Order</Button>
